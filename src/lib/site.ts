...
// When the custom domain is purchased, update SITE_URL here only —
// layout metadata, sitemap, robots, and JSON-LD all read from it.
export const SITE_URL = 'https://munnaza-shamim.vercel.app';
